 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.emf.metro.impl.MetroTreeImpl#isIsRequiredField <em>Is Required Field</em>}</li>
 *   <li>{@link de.dc.emf.metro.impl.MetroTreeImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetroTreeImpl extends CustomizableElementImpl implements MetroTree {
	/**
	...
	protected EClass eStaticClass() {
		return MetroPackage.Literals.METRO_TREE;
	}
	...
	public void setIsRequiredField(boolean newIsRequiredField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetroPackage.METRO_TREE__IS_REQUIRED_FIELD, oldIsRequiredField, isRequiredField));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetroPackage.METRO_TREE__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetroPackage.METRO_TREE__IS_REQUIRED_FIELD:
				return isIsRequiredField();
			case MetroPackage.METRO_TREE__DESCRIPTION:
