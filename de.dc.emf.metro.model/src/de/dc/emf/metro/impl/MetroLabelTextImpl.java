 ...
 * </p>
 * <ul>
 *   <li>{@link de.dc.emf.metro.impl.MetroLabelTextImpl#isIsRequiredField <em>Is Required Field</em>}</li>
 *   <li>{@link de.dc.emf.metro.impl.MetroLabelTextImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetroLabelTextImpl extends CustomizableElementImpl implements MetroLabelText {
	/**
	...
	protected EClass eStaticClass() {
		return MetroPackage.Literals.METRO_LABEL_TEXT;
	}
	...
	public void setIsRequiredField(boolean newIsRequiredField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetroPackage.METRO_LABEL_TEXT__IS_REQUIRED_FIELD, oldIsRequiredField, isRequiredField));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetroPackage.METRO_LABEL_TEXT__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetroPackage.METRO_LABEL_TEXT__IS_REQUIRED_FIELD:
				return isIsRequiredField();
			case MetroPackage.METRO_LABEL_TEXT__DESCRIPTION:
