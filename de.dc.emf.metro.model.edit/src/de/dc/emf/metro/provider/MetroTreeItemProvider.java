...
/**
 * This is the item provider adapter for a {@link de.dc.emf.metro.MetroTree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetroTreeItemProvider extends CustomizableElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetroTreeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MetroTree"));
	}
	...
	public String getText(Object object) {
		String label = ((MetroTree)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetroTree_type") :
			getString("_UI_MetroTree_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MetroTree.class)) {
